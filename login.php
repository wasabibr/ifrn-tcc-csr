...
if(isset($_POST['email_principal']) || isset($_POST['senha_usuario'])) {

    if(strlen($_POST['email_principal']) == 0) {
                    ...
                    <div class="card-body text-start">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="email_principal" placeholder="Digite seu e-mail" aria-describedby="basic-addon1">
                            </div>
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">
                                ...
                                <input type="password" name="senha_usuario" placeholder="Digite sua senha" class="form-control" aria-describedby="basic-addon1">
                            </div>
